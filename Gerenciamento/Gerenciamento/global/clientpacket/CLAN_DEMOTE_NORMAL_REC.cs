...
// Type: Game.global.clientpacket.CLAN_DEMOTE_NORMAL_REC
...
namespace Game.global.clientpacket
{
  public class CLAN_DEMOTE_NORMAL_REC : ReceiveGamePacket
  {
    ...
    public CLAN_DEMOTE_NORMAL_REC(GameClient client, byte[] data) => this.makeme(client, data);
    ...
    public override void read()
    {
      ...
      else
      {
        ...
        for (int index = 0; index < num; ++index)
        {
          ...
          if (account != null && account.clanId == clan.id && (account.clanAccess == 2 && ComDiv.updateDB("accounts", "clanaccess", (object) 3, "player_id", (object) account.player_id)))
          {
