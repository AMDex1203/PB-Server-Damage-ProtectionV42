...
// Type: Game.data.managers.AccountManager
...
namespace Game.data.managers
{
  public static class AccountManager
  {
    ...
    public static Account getAccountDB(object valor, int type) => AccountManager.getAccountDB(valor, type, 35);
    ...
    public static bool updatePlayerName(string name, long playerId) => ComDiv.updateDB("accounts", "player_name", (object) name, "player_id", (object) playerId);
  }
}
